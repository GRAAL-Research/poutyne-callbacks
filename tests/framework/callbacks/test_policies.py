...
from poutyne.callbacks.callbacks.policies import linspace, cosinespace
from poutyne.callbacks.callbacks.policies import Phase, OptimizerPolicy
from poutyne.callbacks.callbacks.policies import one_cycle_phases, sgdr_phases
